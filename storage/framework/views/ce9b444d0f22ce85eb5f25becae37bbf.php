    ...
    <div class="container-fluid py-4">
        ...
        <div class="row mb-4">
            <div class="col-md-3 mb-3">
                <div class="stats-card">
                    <div class="stats-number"><?php echo e($orders->total()); ?></div>
                    <div class="stats-label">Tổng số đơn hàng</div>
                </div>
            </div>
            <div class="col-md-3 mb-3">
                <div class="stats-card">
                    <div class="stats-number"><?php echo e($orders->where('created_at', '>=', now()->startOfMonth())->count()); ?></div>
                    <div class="stats-label">Đơn hàng mới</div>
                </div>
            </div>
            <div class="col-md-3 mb-3">
                <div class="stats-card">
                    <div class="stats-number"><?php echo e($orders->sum(fn($order) => $order->items->sum('quantity'))); ?></div>
                    <div class="stats-label">Tổng sản phẩm</div>
                </div>
            </div>
            <div class="col-md-3 mb-3">
                <div class="stats-card">
                    <div class="stats-number"><?php echo e($orders->unique('customer_id')->count()); ?></div>
        ...
        <div class="table-container">
            <div class="table-header">
                ...
                <span class="badge bg-light text-dark"><?php echo e($orders->total()); ?> đơn hàng</span>
            </div>
                ...
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="order-row" data-order-id="<?php echo e($order->id); ?>" data-status="<?php echo e($order->status); ?>">
                                <td class="text-center">
                                    <div class="fw-bold text-primary">#<?php echo e($order->id); ?></div>
                                    ...
                                    <div class="d-flex align-items-start">
                                        ...
                                        <div class="flex-grow-1">
                                            <div class="fw-semibold text-dark mb-1 customer-name">
                                                <?php echo e($order->fullname ?? 'Khách vãng lai'); ?>

                                            </div>
                                            <div class="text-muted small">
                                                <i class="fas fa-phone me-1"></i><?php echo e($order->tel ?? 'N/A'); ?>

                                            </div>
                                            <div class="text-muted small">
                                                <i class="fas fa-map-marker-alt me-1"></i>
                                                <span class="text-truncate d-inline-block" style="max-width: 200px;">
                                                    <?php echo e($order->address ?? 'Chưa cập nhật'); ?>
                                ...
                                <td class="text-center">
                                    <div class="d-flex flex-column align-items-center">
                                        <span class="badge bg-primary rounded-pill fs-6 mb-1">
                                            <?php echo e($order->items->count()); ?> sp
                                        </span>
                                        <small class="text-muted">
                                            <?php echo e($order->items->sum('quantity')); ?> cái
                                        </small>
                                    </div>
                                </td>
                                <td class="text-end">
                                    <div class="fw-bold text-danger fs-6 order-total">
                                        <?php echo e(number_format($order->total ?? 0, 0, ',', '.')); ?>₫
                                    </div>
                                ...
                                <td class="text-center">
                                    ...
                                    ?>
                                    <span class="badge <?php echo e($status[0]); ?> text-white">
                                        <i class="fas fa-<?php echo e($status[2]); ?> me-1"></i><?php echo e($status[1]); ?>
                                ...
                                <td class="text-center">
                                    <div class="btn-group" role="group">
                                        ...
                                        <a href="<?php echo e(route('ad.orders.show', $order->id)); ?>"
        ...
        <?php if($orders->hasPages()): ?>
            <div class="d-flex justify-content-between align-items-center mt-4">
                <div class="text-muted">
                    Hiển thị <?php echo e($orders->firstItem()); ?> - <?php echo e($orders->lastItem()); ?> của <?php echo e($orders->total()); ?> đơn hàng
                </div>
                <nav>
...
<?php $__env->startSection('styles'); ?>
    <link rel="stylesheet" href="<?php echo e(asset('css/ad.index.order.css')); ?>">
<?php $__env->stopSection(); ?>
...
<?php echo $__env->make('layout.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\testCDTT\FinalAssignment_2123110231_NguyenTuanVu\resources\views/admin/orders/index.blade.php ENDPATH**/ ?>