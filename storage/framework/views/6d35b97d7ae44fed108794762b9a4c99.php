...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid py-4">
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-3 mb-3">
                <div class="stats-card">
                    <div class="stats-number"><?php echo e($orders->sum(fn($order) => $order->items->count())); ?></div>
                                    ...
                                    <div class="d-flex align-items-start">
                                        ...
                                        <div class="flex-grow-1">
                                            <div class="fw-semibold text-dark mb-1">
                                                <?php echo e($order->customer->fullname ?? 'Khách vãng lai'); ?>

                                            </div>
                                            <div class="text-muted small">
                                                <i class="fas fa-phone me-1"></i><?php echo e($order->customer->tel ?? 'N/A'); ?>

                                            </div>
                                            <div class="text-muted small">
                                                <i class="fas fa-map-marker-alt me-1"></i>
                                                <span class="text-truncate d-inline-block" style="max-width: 200px;">
                                                    <?php echo e($order->customer->address ?? 'Chưa cập nhật'); ?>
                                ...
                                <td>
                                    <div class="d-flex justify-content-center gap-1">
                                        ...
                                        <button class="btn btn-sm btn-outline-warning"
                                            onclick="editOrder(<?php echo e($order->id); ?>)" title="Cập nhật trạng thái">
