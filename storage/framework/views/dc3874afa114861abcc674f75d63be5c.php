...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="login-footer">
                <a href="<?php echo e(route('ad.create')); ?>">CREATE ACCOUNT</a>
                <a href="<?php echo e(route('ad.forgotpass')); ?>">FORGOT PASSWORD</a>
            </div>
        </div>
    </div>
...
<?php /**PATH D:\c#+CĐTT\FinalAssignment_2123110231_NguyenTuanVu\resources\views/admin/users/login.blade.php ENDPATH**/ ?>