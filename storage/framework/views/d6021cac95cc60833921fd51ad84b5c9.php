                    ...
                    <div class="card brand-card h-100 border-0 shadow-sm">
                        ...
                        <div class="brand-image-container position-relative">
                            <div class="brand-image-placeholder">
                                <?php if($brand->logo): ?>
                                    <img src="<?php echo e(asset('storage/' . $brand->logo)); ?>" alt="<?php echo e($brand->brandname); ?>"
                                        class="brand-logo"
                                        onerror="this.style.display='none'; this.nextElementSibling.style.display='flex'">
                                <?php endif; ?>
                                <div class="brand-initials <?php echo e(!$brand->logo ? 'd-flex' : 'd-none'); ?>">
                                    <?php echo e(strtoupper(substr($brand->brandname, 0, 2))); ?>
...
<?php echo $__env->make('layout.client', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\FinalAssignment_2123110231_NguyenTuanVu\resources\views\client\brands\index.blade.php ENDPATH**/ ?>