                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="fullname" name="fullname"
                            value="<?php echo e(old('fullname')); ?>" placeholder="ENTER FULL NAME">
                    </div>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-4">
                    ...
                    <select class="form-select" id="role" name="role">
                        <option value="1" <?php echo e(old('role') == '1' ? 'selected' : ''); ?>>ADMINISTRATOR</option>
                        <option value="3" <?php echo e(old('role') == '3' ? 'selected' : ''); ?>>CLIENT</option>
                    </select>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="register-footer">
                <a href="<?php echo e(route('ad.login')); ?>">ALREADY HAVE AN ACCOUNT? LOGIN</a>
            </div>
        </div>
    </div>
...
<?php /**PATH E:\FinalAssignment_2123110231_NguyenTuanVu\resources\views\admin\users\create.blade.php ENDPATH**/ ?>