                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="text" class="form-control" id="f-fullname" name="fullname"
                                                value="<?php echo e(old('fullname', $user->name ?? '')); ?>" placeholder="Họ và tên"
                                                required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="text" class="form-control" id="f-tel" name="tel"
                                                value="<?php echo e(old('tel', $user->tel ?? '')); ?>" placeholder="Số điện thoại"
                                                required>
