                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $user->orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div class="glass-card order-card">
                                ...
                                <div class="order-actions">
                                    <a href="<?php echo e(route('client.orders.show', $order->id)); ?>"
            ...
            <div id="address" class="content-section">
                <div class="glass-card p-4">
                    ...
                    <div class="address-grid">
                        <?php $__empty_1 = true; $__currentLoopData = $user->shippingAddresses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $address): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div class="glass-card address-card <?php echo e($address->is_default ? 'primary' : ''); ?>">
                                <?php if($address->is_default): ?>
                                    <span class="address-badge">Mặc Định</span>
                                <?php endif; ?>
                                <div class="address-content">
                                    <h4><?php echo e($address->fullname); ?></h4>
                                    <div class="address-details">
                                        <p><i
                                                class="fas fa-phone me-2 text-muted"></i><strong><?php echo e($address->phone); ?></strong>
                                        </p>
                                        <p><i
                                                class="fas fa-map-marker-alt me-2 text-muted"></i><?php echo e($address->address); ?>
                                ...
                                <div class="address-actions">
                                    <?php if(!$address->is_default): ?>
                                        <form action="<?php echo e(route('client.shipping-addresses.set-default', $address)); ?>"
                                    ...
                                    <?php endif; ?>
                                    <a href="<?php echo e(route('client.shipping-addresses.edit', $address)); ?>"
                                        class="btn-action btn-primary" title="Chỉnh sửa">
                                        <i class="fas fa-edit me-2"></i>Sửa
                                    </a>
                                    <form action="<?php echo e(route('client.shipping-addresses.destroy', $address)); ?>"
                                        method="POST" class="d-inline">
                                        <?php echo csrf_field(); ?>
                    ...
                    <div class="text-center mt-4">
                        <a href="<?php echo e(route('client.shipping-addresses.create')); ?>" class="btn-action btn-primary">
                ...
                <div class="glass-card p-4">
                    ...
                    <div class="info-grid">
                        <div class="glass-card info-card">
                            ...
                            <a href="<?php echo e(route('ad.reset.form', $user->id)); ?>" class="btn-action btn-warning">
