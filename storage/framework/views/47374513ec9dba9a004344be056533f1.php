...
<body>
    <div class="container py-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <a href="<?php echo e(route('ad.brand.index')); ?>" class="back-btn">
...
<?php endif; ?>
                        ...
                        <!-- Form -->
                        <form method="POST" action="<?php echo e(route('ad.brand.store')); ?>">
                            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="d-flex justify-content-between align-items-center mt-4 pt-3 border-top">
                                <a href="<?php echo e(route('ad.brand.index')); ?>" class="btn btn-outline-secondary">
...
<?php /**PATH D:\testCDTT\FinalAssignment_2123110231_NguyenTuanVu\resources\views\admin\brands\create.blade.php ENDPATH**/ ?>