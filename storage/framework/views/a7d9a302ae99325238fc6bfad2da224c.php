                ...
                <div class="card shadow-sm border-0">
                    <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                        ...
                        <span class="badge bg-light text-dark fs-6">
                            Tổng: <?php echo e($users->count()); ?> người dùng
                        </span>
                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div
                                                        ...
                                                        <?php echo e(strtoupper(substr($user->fullname, 0, 1))); ?>
                                            ...
                                            <td>
                                                <a href="mailto:<?php echo e($user->email); ?>" class="text-decoration-none">
                                                    <i class="fas fa-envelope me-1 text-primary"></i><?php echo e($user->email); ?>
                                            ...
                                            <td>
                                                <small class="text-muted d-block mb-1">
                                                    ...
                                                    <?php echo e($user->created_at ? $user->created_at->timezone('Asia/Ho_Chi_Minh')->format('d/m/Y') : 'N/A'); ?>

                                                </small>
                                                <small class="text-muted d-block">
                                                    <i class="fas fa-clock me-1"></i>
                                                    <?php echo e($user->created_at ? $user->created_at->timezone('Asia/Ho_Chi_Minh')->format('H:i') : 'N/A'); ?>
                        ...
                        <?php if($users->hasPages()): ?>
                            <div class="d-flex justify-content-between align-items-center mt-4 flex-wrap gap-3">
                                <div class="text-muted">
                                    Hiển thị <span class="fw-bold"><?php echo e($users->firstItem() ?? 0); ?></span> -
                                    <span class="fw-bold"><?php echo e($users->lastItem() ?? 0); ?></span>
                                    trong tổng số <span class="fw-bold"><?php echo e($users->total()); ?></span> người dùng
                                </div>
                                <nav>
...
<?php echo $__env->make('layout.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\testCDTT\FinalAssignment_2123110231_NguyenTuanVu\resources\views/admin/users/index.blade.php ENDPATH**/ ?>