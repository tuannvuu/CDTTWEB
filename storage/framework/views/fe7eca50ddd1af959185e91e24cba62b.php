        ...
        <?php else: ?>
            <div class="table-container">
                <div class="empty-state">
                    ...
                    <a href="<?php echo e(route('pro.create')); ?>" class="btn btn-success">
                        <i class="fas fa-plus me-2"></i>Thêm sản phẩm
                    </a>
                </div>
            </div>
...
<?php echo $__env->make('layout.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\c#+CĐTT\FinalAssignment_2123110231_NguyenTuanVu\resources\views/admin/products/index.blade.php ENDPATH**/ ?>