                            ...
                            <a href="<?php echo e(route('client.products.detail', $product->id)); ?>"
                                ...
                                <div class="card-body p-2">
                                    <div class="text-center">
                                        <h4 class="fw-bolder"><?php echo e($product->proname); ?></h4>
                                    </div>
                                </div>
                            </a>
...
<?php echo $__env->make('layout.client', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\testCDTT\FinalAssignment_2123110231_NguyenTuanVu\resources\views\homepage.blade.php ENDPATH**/ ?>