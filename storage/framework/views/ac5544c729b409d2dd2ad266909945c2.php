...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid py-4">
            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h1 class="page-title text-white mb-1">Chi tiết Đơn hàng #<?php echo e($order->id); ?></h1>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 text-md-end mt-3 mt-md-0">
                    <a href="<?php echo e(route('ad.orders.index')); ?>" class="btn btn-light rounded-pill px-4">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <span
                            ...
                            <?php elseif($order->status == 'shipping'): ?> bg-primary
                            <?php elseif($order->status == 'completed'): ?> bg-success
                            <?php elseif($order->status == 'cancelled'): ?> bg-danger <?php endif; ?> rounded-pill px-3 py-2 fs-6">
                    ...
                    <div class="text-muted">
                        <small>Đơn hàng tạo lúc:
                            <?php echo e($order->created_at->timezone('Asia/Ho_Chi_Minh')->format('H:i:s d/m/Y')); ?></small>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="info-item mb-3 pb-3 border-bottom">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <div class="fw-semibold"><?php echo e($order->fullname ?? 'Khách vãng lai'); ?></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="info-item mb-3 pb-3 border-bottom">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <div class="fw-semibold"><?php echo e($order->tel ?? 'N/A'); ?></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="info-item mb-3 pb-3 border-bottom">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <div class="fw-semibold"><?php echo e($order->email ?? 'N/A'); ?></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="info-item">
                            <div class="d-flex align-items-start">
                                ...
                                <div>
                                    ...
                                    <div class="fw-semibold"><?php echo e($order->address ?? 'Chưa cập nhật'); ?></div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="info-item mb-3 pb-3 border-bottom">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <div class="fw-semibold">#<?php echo e($order->id); ?></div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <div class="fw-semibold">
                                        <?php echo e($order->created_at->timezone('Asia/Ho_Chi_Minh')->format('H:i:s d/m/Y')); ?></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="info-item mb-3 pb-3 border-bottom">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <div class="fw-semibold">
                                        <?php echo e($order->updated_at->timezone('Asia/Ho_Chi_Minh')->format('H:i:s d/m/Y')); ?></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="info-item">
                            <div class="d-flex align-items-start">
                                ...
                                <div>
                                    ...
                                    <div class="fw-semibold"><?php echo e($order->description ?? 'Không có ghi chú'); ?></div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <tbody>
                            ...
                            <?php $__currentLoopData = $order->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <?php if($item->product && $item->product->fileName): ?>
                                                <img src="<?php echo e(asset('storage/products/' . $item->product->fileName)); ?>"
                                                    alt="<?php echo e($item->product->proname); ?>" class="rounded me-3 product-img">
                                            <?php else: ?>
                                                <div
                                            ...
                                            <div>
                                                ...
                                                <small class="text-muted">ID:
                                                    <?php echo e(optional($item->product)->id ?? 'N/A'); ?></small>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td class="text-end fw-semibold pe-4"><?php echo e(number_format($lineTotal, 0, ',', '.')); ?> đ
                                    </td>
                                </tr>
        ...
        <div class="d-flex justify-content-end gap-3 mt-4">
            <a href="<?php echo e(route('ad.orders.index')); ?>" class="btn btn-outline-secondary rounded-pill px-4">
            ...
            <?php else: ?>
                <button class="btn btn-warning rounded-pill px-4" onclick="editOrder(<?php echo e($order->id); ?>)">
                    <i class="fas fa-edit me-2"></i>Cập nhật trạng thái
                </button>
            ...
            <div class="modal-content border-0 shadow-lg">
                <div class="modal-header bg-primary text-white rounded-top">
                    <h5 class="modal-title" id="statusModalLabel">
                        <i class="fas fa-sync-alt me-2"></i>Cập nhật trạng thái Đơn hàng #<?php echo e($order->id); ?>

                    </h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"
                        aria-label="Close"></button>
                </div>
                <form id="updateStatusForm" action="<?php echo e(route('ad.orders.updateStatus', $order->id)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="modal-body p-4">
                        <div class="mb-3">
                            ...
                            <select class="form-select rounded-pill py-2 px-3" id="status" name="status">
                                <option value="pending" <?php if($order->status == 'pending'): ?> selected <?php endif; ?>>🟡 Chờ xử lý
                                </option>
                                <option value="confirmed" <?php if($order->status == 'confirmed'): ?> selected <?php endif; ?>>🔵 Đã xác nhận
                                </option>
                                <option value="shipping" <?php if($order->status == 'shipping'): ?> selected <?php endif; ?>>🚚 Đang giao
                                </option>
                                <option value="completed" <?php if($order->status == 'completed'): ?> selected <?php endif; ?>>✅ Hoàn thành
                                </option>
                                <option value="cancelled" <?php if($order->status == 'cancelled'): ?> selected <?php endif; ?>>❌ Đã hủy
                                </option>
                            </select>
                        </div>
                    </div>
...
<?php $__env->startSection('styles'); ?>
    <link rel="stylesheet" href="<?php echo e(asset('css/ad.show.order.css')); ?>">
    <style>
        .page-header {
    ...
    <script>
        ...
        function confirmDelete(id, name) {
            if (confirm(`Bạn có chắc muốn hủy ${name}? Hành động này không thể hoàn tác.`)) {
                ...
                form.action = '<?php echo e(route('ad.orders.destroy', ['id' => ':id'])); ?>'.replace(':id', id);
                form.submit();
            }
        }
