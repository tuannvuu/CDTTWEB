...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid py-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="<?php echo e(route('ad.cate.index')); ?>" class="btn btn-outline-secondary">
            ...
            <div class="col-lg-6 col-xl-5">
                <div class="card shadow-sm border-0">
                    ...
                    <div class="card-body p-4">
                        ...
                        <!-- Form -->
                        <form method="POST" action="<?php echo e(route('ad.cate.store')); ?>" id="categoryForm">
                            <?php echo csrf_field(); ?>
...
<link rel="stylesheet" href="<?php echo e(asset('css/create.category.css')); ?>">
<?php $__env->stopSection(); ?>
