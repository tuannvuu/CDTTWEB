...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/momo.css') }}">
</head>
            ...
            <div class="payment-details">
                ...
                <div class="momo-info-card">
                    ...
                    <div class="info-item">
                        ...
                        <span class="info-value">{{ $momoData['phone'] }}</span>
                    </div>

                    <div class="info-item">
                        <span class="info-label">Chủ tài khoản:</span>
                        <span class="info-value">{{ $momoData['wallet_name'] }}</span>
                    </div>
                    ...
                    <div class="info-item">
                        ...
                        <div class="d-flex align-items-center gap-2">
                            <span class="info-value">MOMO{{ $order_id }}</span>
                            <button class="copy-btn" onclick="copyToClipboard('MOMO{{ $order_id }}')">
                ...
                <div class="qr-container">
                    ...
                    <img src="{{ asset('storage/payments/momo.jpg') }}" alt="QR Code" class="qr-image">
                ...
                <!-- Action Button -->
                <a href="{{ route('order.success', ['order_id' => $order_id]) }}" class="btn-momo">
        ...
        <div class="text-center mt-4">
            <p class="text-muted">
                <small>
                    ...
                    • Kiểm tra chính xác nội dung chuyển khoản: <strong>MOMO{{ $order_id }}</strong><br>
