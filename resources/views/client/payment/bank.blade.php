            ...
            <div class="payment-details">
                ...
                <div class="order-summary">
                    ...
                    <div class="total-amount">
                        ...
                        <div class="h4 mb-0">{{ number_format($totalAmount, 0, ',', '.') }} VNĐ</div>
                    </div>
                </div>
                ...
                <div class="bank-info-card">
                    ...
                    <div class="info-item">
                        ...
                        <span class="info-value">{{ $bankData['bank_name'] }}</span>
                    </div>

                    <div class="info-item">
                        <span class="info-label">Số tài khoản:</span>
                        <div class="d-flex align-items-center gap-2">
                            <span class="info-value">{{ $bankData['account_no'] }}</span>
                            <button class="copy-btn" onclick="copyToClipboard('{{ $bankData['account_no'] }}')">
                    ...
                    <div class="info-item">
                        ...
                        <div class="d-flex align-items-center gap-2">
                            <span class="info-value">{{ $bankData['account_name'] }}</span>
                            <button class="copy-btn" onclick="copyToClipboard('{{ $bankData['account_name'] }}')">
                                <i class="bi bi-copy"></i>
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="info-item">
                        ...
                        <span class="info-value amount-highlight">{{ number_format($totalAmount, 0, ',', '.') }}
                            VNĐ</span>
                    </div>
                    ...
                    <div class="info-item">
                        ...
                        <div class="d-flex align-items-center gap-2">
                            <span class="info-value">THANHTOAN{{ $order_id }}</span>
                            <button class="copy-btn" onclick="copyToClipboard('THANHTOAN{{ $order_id }}')">
                                <i class="bi bi-copy"></i>
                            </button>
                        </div>
                    </div>
                ...
                <div class="qr-container">
                    ...
                    <img src="{{ asset('storage/payments/bank.jpg') }}" alt="QR Code" class="qr-image">
                ...
                <div class="steps-guide">
                    ...
                    <div class="step-item">
                        ...
                        <div class="step-content">
                            ...
                            <small class="text-muted d-block">Nhập nội dung: THANHTOAN{{ $order_id }}</small>
                        </div>
                    </div>
                </div>

                <!-- Action Button -->
                <a href="{{ route('order.success', ['order_id' => $order_id]) }}" class="btn-bank">
        ...
        <div class="text-center mt-4">
            <p class="text-muted">
                <small>
                    ...
                    • Nhập chính xác nội dung chuyển khoản: <strong>THANHTOAN{{ $order_id }}</strong><br>
