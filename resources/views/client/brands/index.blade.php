...
@section('content')
    <div class="container py-5">
     ...
     alt="{{ $brand->brandname }}" class="img-fluid" style="max-height:80px;">

                            </div>
                            <div class="brand-overlay">
                                <a href="{{ route('client.brands.show', $brand->id) }}" class="btn btn-primary btn-sm">
                        ...
                        <div class="card-body text-center">
                            <h5 class="card-title fw-bold text-dark mb-2">{{ $brand->brandname }}</h5>
                            ...
                            <div class="brand-stats d-flex justify-content-center gap-3 text-center mb-3">
                                <div>
                                    <div class="fw-bold text-primary">{{ rand(1, 7) }}</div>
