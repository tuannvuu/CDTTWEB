            ...
            <div class="col-md-8 col-lg-6">
                ...
                <div class="card shadow-sm border-0 rounded-3">
                    <div class="card-body p-4 p-md-5">
                        <form action="{{ route('ad.changepass') }}" method="POST" id="passwordChangeForm">
                            @csrf
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    <input type="password" name="current_password"
                                        class="form-control rounded-2 py-3 px-3 @error('current_password') is-invalid @enderror"
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    <input type="password" name="new_password"
                                        class="form-control rounded-2 py-3 px-3 @error('new_password') is-invalid @enderror"
