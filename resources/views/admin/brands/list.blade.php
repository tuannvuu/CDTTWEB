...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/list.brands.css') }}">
</head>
        ...
        <div class="page-header">
            <div class="row align-items-center">
                ...
                <div class="col-md-6 text-md-end">
                    <a href="{{ route('ad.brand.create') }}" class="btn btn-light btn-lg">
        ...
        <div class="row mb-4">
            <div class="col-md-3 mb-3">
                <div class="stats-card">
                    <div class="stats-number">{{ count($list) }}</div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="brand-name">
                                            <i class="fas fa-tag text-primary me-2"></i>{{ $item->brandname }}
                                        </span>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="action-buttons">
                                            <a href="{{ route('ad.brand.edit', $item->id) }}"
                                                class="btn btn-action btn-edit" title="Sửa thương hiệu">
                                                <i class="fas fa-edit me-1"></i>Sửa
                                            </a>
                                            <form action="{{ route('ad.brand.delete', $item->id) }}" method="POST"
                                                class="d-inline">
                                                @csrf
                                                <button type="submit" class="btn btn-action btn-delete"
                                                    onclick="return confirm('Bạn có chắc muốn xóa {{ $item->brandname }}?')"
                            ...
                            <tr>
                                <td colspan="4">
                                    <div class="empty-state">
                                        ...
                                        <a href="{{ route('brand.create') }}" class="btn btn-primary-custom">
